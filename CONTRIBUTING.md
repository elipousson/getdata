...
This outlines how to propose a change to getdata (using the same
contribution guidelines as tidyverse packages). See the tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("elipousson/getdata", fork = TRUE)`.
...
Please note that the getdata project is released with a [Contributor
Code of
Conduct](https://elipousson.github.io/getdata/CODE_OF_CONDUCT.md). By
